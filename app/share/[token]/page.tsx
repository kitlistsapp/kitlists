              ...
              <div key={cam.id} className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
                ...
                {cam.bodyName && (
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    {isProduction && cam.camera_body_source === 'dop_owned' && <span className="text-xs bg-zinc-800 text-zinc-500 px-2 py-0.5 rounded-full">Supplied</span>}
                  </div>
                )}
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-3">
                  {powerItems.length > 0 && <div><span className="text-zinc-600 text-xs uppercase tracking-wider">Power</span>{powerItems.map((i: any) => <div key={i.id} className="flex items-center gap-1.5 mt-1"><span className="text-zinc-300 text-sm">{i.equipment_items?.name || i.custom_label}{i.quantity > 1 ? ` x${i.quantity}` : ''}</span>{!isProduction && i.source === 'dop_owned' && <span className="text-xs bg-orange-950 text-orange-400 px-1.5 py-0.5 rounded-full">DOP</span>}{isProduction && i.source === 'dop_owned' && <span className="text-xs bg-zinc-800 text-zinc-500 px-1.5 py-0.5 rounded-full">Supplied</span>}</div>)}</div>}
                  {aksItems.length > 0 && <div><span className="text-zinc-600 text-xs uppercase tracking-wider">AKS</span>{aksItems.map((i: any) => <div key={i.id} className="flex items-center gap-1.5 mt-1"><span className="text-zinc-300 text-sm">{i.equipment_items?.name || i.custom_label}{i.quantity > 1 ? ` x${i.quantity}` : ''}</span>{!isProduction && i.source === 'dop_owned' && <span className="text-xs bg-orange-950 text-orange-400 px-1.5 py-0.5 rounded-full">DOP</span>}{isProduction && i.source === 'dop_owned' && <span className="text-xs bg-zinc-800 text-zinc-500 px-1.5 py-0.5 rounded-full">Supplied</span>}</div>)}</div>}
                  {gripItems.length > 0 && <div className="mt-2"><span className="text-zinc-600 text-xs uppercase tracking-wider">Grip</span>{gripItems.map((i: any) => <div key={i.id} className="flex items-center gap-1.5 mt-1"><span className="text-zinc-300 text-sm">{i.equipment_items?.name || i.custom_label}{i.quantity > 1 ? ` x${i.quantity}` : ''}</span>{!isProduction && i.source === 'dop_owned' && <span className="text-xs bg-orange-950 text-orange-400 px-1.5 py-0.5 rounded-full">DOP</span>}{isProduction && i.source === 'dop_owned' && <span className="text-xs bg-zinc-800 text-zinc-500 px-1.5 py-0.5 rounded-full">Supplied</span>}</div>)}</div>}
                  {filtItems.length > 0 && <div className="mt-2"><span className="text-zinc-600 text-xs uppercase tracking-wider">Filtration</span>{filtItems.map((i: any) => <div key={i.id} className="flex items-center gap-1.5 mt-1"><span className="text-zinc-300 text-sm">{i.equipment_items?.name || i.custom_label}</span>{!isProduction && i.source === 'dop_owned' && <span className="text-xs bg-orange-950 text-orange-400 px-1.5 py-0.5 rounded-full">DOP</span>}{isProduction && i.source === 'dop_owned' && <span className="text-xs bg-zinc-800 text-zinc-500 px-1.5 py-0.5 rounded-full">Supplied</span>}</div>)}</div>}
                </div>
