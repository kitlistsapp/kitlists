    ...
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      <footer className="px-6 py-6 border-t border-zinc-900">
        <div className="max-w-2xl mx-auto flex items-center justify-between">
          <span className="text-zinc-600 text-xs">© 2026 KitLists. All rights reserved.</span>
          <a href="https://www.instagram.com/kitlists.app" target="_blank" rel="noopener noreferrer" className="text-zinc-500 hover:text-[#FFE135] transition-colors flex items-center gap-1.5 text-xs">
