...
export function inviteHtml(firstName?: string | null) {
  ...
  return wrapper(`
    ...
    <table style="width: 100%; border-collapse: collapse; margin: 0 0 20px;">
      ...
      ${featureRow('3', 'DOP and 1st AC prep together', 'both on the same live list - kit added and badged DOP or AC owned as you go.')}
...
export function followupHtml(firstName?: string | null) {
  ...
  return wrapper(`
    ...
    <p style="color: #a1a1aa; font-size: 14px; line-height: 1.65; margin: 0 0 24px;">
      It's <strong style="color: #FFE135;">free during beta</strong> and built here in Sydney by working crew. Next job that lands, give it a go - if it doesn't save you time, delete the account and I'll never nudge you again.
    </p>
...
export function reengageHtml(firstName?: string | null) {
  ...
  return wrapper(`
    ...
    <p style="color: #a1a1aa; font-size: 14px; line-height: 1.65; margin: 0 0 20px;">
      Here's what a first list looks like - most people do it in under 10 minutes:
    </p>
    ...
    <table style="width: 100%; border-collapse: collapse; margin: 0 0 20px;">
      ...
      ${featureRow('3', 'Prep together', 'DOP and 1st AC on the same live list - kit added and badged as you go.')}
